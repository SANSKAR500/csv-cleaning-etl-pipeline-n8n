...
Want to poke at it? Open <a href="assets/interactive-pipeline.html">assets/interactive-pipeline.html</a> in a browser: hover a node to trace its connections, click one for a plain-English explanation, or hit "Pause flow".</p>

Text version, for anywhere images/HTML don't render:
...
/assets/
  pipeline-animated.svg          ← animated diagram embedded above
  interactive-pipeline.html      ← hoverable/clickable version of the same diagram
README.md
```
